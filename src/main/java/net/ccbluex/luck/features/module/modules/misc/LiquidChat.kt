...
import net.ccbluex.luck.chat.Client
import net.ccbluex.luck.chat.packet.packets.*
...
import net.ccbluex.luck.utils.login.UserUtils
...
@ModuleInfo(name = "LiquidChat", description = "Allows you to chat with other luck users.", category = ModuleCategory.MISC)
