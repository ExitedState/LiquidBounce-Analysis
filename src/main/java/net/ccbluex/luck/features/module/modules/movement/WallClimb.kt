...
import net.ccbluex.luck.utils.block.BlockUtils.collideBlockIntersects
...
class WallClimb : Module() {
    ...
    fun onBlockBB(event: BlockBBEvent) {
        ...
        when (mode.lowercase(Locale.getDefault())) {
            ...
            "clip" -> if (event.block != null && mc.thePlayer != null && event.block == Blocks.air && event.y < thePlayer.posY && thePlayer.isCollidedHorizontally && !thePlayer.isOnLadder && !thePlayer.isInWater && !thePlayer.isInLava) event.boundingBox =
