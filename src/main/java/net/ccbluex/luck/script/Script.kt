 ...
 */
package net.ccbluex.luck.script
...
import net.ccbluex.luck.script.api.ScriptCommand
import net.ccbluex.luck.script.api.ScriptModule
import net.ccbluex.luck.script.api.ScriptTab
import net.ccbluex.luck.script.api.global.Chat
import net.ccbluex.luck.script.api.global.Item
import net.ccbluex.luck.script.api.global.Setting
...
class Script(val scriptFile: File) : MinecraftInstance() {
    ...
    private fun supportLegacyScripts() {
        if (getMagicComment("api_version") != "2") {
            ...
            val legacyScript = LiquidBounce::class.java.getResource("/assets/minecraft/luck/scriptapi/legacy.js").readText()
