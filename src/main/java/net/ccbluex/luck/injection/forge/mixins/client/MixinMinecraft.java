 ...
 */
package net.ccbluex.luck.injection.forge.mixins.client;

import net.ccbluex.luck.LiquidBounce;
import net.ccbluex.luck.event.ClickBlockEvent;
import net.ccbluex.luck.event.KeyEvent;
import net.ccbluex.luck.event.TickEvent;
import net.ccbluex.luck.event.WorldEvent;
import net.ccbluex.luck.features.module.modules.combat.AutoClicker;
import net.ccbluex.luck.features.module.modules.exploit.AbortBreaking;
import net.ccbluex.luck.features.module.modules.exploit.MultiActions;
import net.ccbluex.luck.features.module.modules.world.FastPlace;
import net.ccbluex.luck.injection.forge.SplashProgressLock;
import net.ccbluex.luck.utils.CPSCounter;
import net.ccbluex.luck.utils.render.IconUtils;
import net.ccbluex.luck.utils.render.MiniMapRegister;
...
//    }
    ...
    private void createDisplay(CallbackInfo callbackInfo) {
        Display.setTitle("Minecraft 1.8.9 | LabyMod 3.9.4");
