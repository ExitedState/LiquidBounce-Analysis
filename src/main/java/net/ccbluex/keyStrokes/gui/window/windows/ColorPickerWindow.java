...
import net.ccbluex.keyStrokes.gui.window.Component;
import net.ccbluex.keyStrokes.gui.window.Window;
import net.ccbluex.keyStrokes.gui.window.WindowManager;
import net.ccbluex.keyStrokes.gui.window.components.ColorPickerComponent;
import net.ccbluex.keyStrokes.gui.window.components.SliderComponent;
