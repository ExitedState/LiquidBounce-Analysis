package net.keyStrokes.gui;

import com.google.common.collect.Sets;
import net.keyStrokes.Helper;
import net.keyStrokes.KeyConfiguration;
import net.keyStrokes.KeystrokesMod;
...
import net.keyStrokes.gui.window.windows.KeyConfigWindow;
...
public class KeystrokesModGUI extends GuiScreen {
    ...
    private final Set<RenderedKey> selection = new HashSet<>(); // Currently selected keys
