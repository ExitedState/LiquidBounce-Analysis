...
var _AdaptedModule = function (module) {
    ...
    this.moduleManager = Java.type("net.ccbluex.luck.LiquidBounce").moduleManager;
...
var _ModuleManager = function () {
    ...
    this.moduleManager = Java.type("net.ccbluex.luck.LiquidBounce").moduleManager;
    this.Module = Java.type("net.ccbluex.luck.features.module.Module");
...
var _CommandManager = function () {
    ...
    this.Command = Java.type("net.ccbluex.luck.features.command.Command");
    this.commandManager = Java.type("net.ccbluex.luck.LiquidBounce").commandManager;
